...
/**
 * Provides Total Monthly Expenses field handler.
 *
 * @ViewsField("monthly_budget_tracker_total_monthly_expenses")
 *
 * @DCG
 ...
 * self::query() method.
 */
class TotalMonthlyExpenses extends FieldPluginBase {
  ...
  public function render(ResultRow $values) {
    ...
    return "$".$entity->getTotalExpenses(TRUE);
  }
