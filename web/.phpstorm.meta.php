...
namespace PHPSTORM_META {
  ...
  override(
    ...
    map([
      ...
      'devel_entity_updates.command' => '\Drupal\devel_entity_updates\Commands\DevelEntityUpdatesCommands',
  ...
  override(
    ...
    map([
      ...
      'income_source' => '\Drupal\Core\Entity\Sql\SqlContentEntityStorage',
      'monthly_budget' => '\Drupal\Core\Entity\Sql\SqlContentEntityStorage',
      'monthly_expense' => '\Drupal\Core\Entity\Sql\SqlContentEntityStorage',
  ...
  override(
    ...
    map([
      ...
      'income_source' => '\Drupal\Core\Entity\EntityViewBuilder',
      'monthly_budget' => '\Drupal\Core\Entity\EntityViewBuilder',
      'monthly_expense' => '\Drupal\Core\Entity\EntityViewBuilder',
  ...
  override(
    ...
    map([
      ...
      'income_source' => '\Drupal\personal_budget_tracker\IncomeSourceListBuilder',
      'monthly_budget' => '\Drupal\personal_budget_tracker\MonthlyBudgetListBuilder',
      'monthly_expense' => '\Drupal\personal_budget_tracker\MonthlyExpenseListBuilder',
  ...
  override(
    ...
    map([
     ...
     'income_source' => '\Drupal\personal_budget_tracker\IncomeSourceAccessControlHandler',
     'monthly_budget' => '\Drupal\Core\Entity\EntityAccessControlHandler',
     'monthly_expense' => '\Drupal\personal_budget_tracker\MonthlyIncomeAccessControlHandler',
  ...
  override(\Drupal\personal_budget_tracker\Entity\IncomeSource::loadMultiple(), map(['' => '\Drupal\personal_budget_tracker\Entity\IncomeSource[]']));
  override(\Drupal\personal_budget_tracker\Entity\IncomeSource::load(), map(['' => '\Drupal\personal_budget_tracker\Entity\IncomeSource']));
  override(\Drupal\personal_budget_tracker\Entity\IncomeSource::create(), map(['' => '\Drupal\personal_budget_tracker\Entity\IncomeSource']));

  override(\Drupal\personal_budget_tracker\Entity\MonthlyBudget::loadMultiple(), map(['' => '\Drupal\personal_budget_tracker\Entity\MonthlyBudget[]']));
  override(\Drupal\personal_budget_tracker\Entity\MonthlyBudget::load(), map(['' => '\Drupal\personal_budget_tracker\Entity\MonthlyBudget']));
  override(\Drupal\personal_budget_tracker\Entity\MonthlyBudget::create(), map(['' => '\Drupal\personal_budget_tracker\Entity\MonthlyBudget']));

  override(\Drupal\personal_budget_tracker\Entity\MonthlyExpense::loadMultiple(), map(['' => '\Drupal\personal_budget_tracker\Entity\MonthlyExpense[]']));
  override(\Drupal\personal_budget_tracker\Entity\MonthlyExpense::load(), map(['' => '\Drupal\personal_budget_tracker\Entity\MonthlyExpense']));
  override(\Drupal\personal_budget_tracker\Entity\MonthlyExpense::create(), map(['' => '\Drupal\personal_budget_tracker\Entity\MonthlyExpense']));
